...
func (api *ConsensusAPI) ForkchoiceUpdatedV1(update engine.ForkchoiceStateV1, payloadAttributes *engine.PayloadAttributesV1) (engine.ForkChoiceResponse, error) {
...
func (api *ConsensusAPI) NewPayloadV1(params engine.ExecutableDataV1) (engine.PayloadStatusV1, error) {
