...
var (
	...
	miscInCommitteeProofPacketsMeter = metrics.NewRegisteredMeter("les/misc/in/packets/committee", nil)
	...
	miscOutCommitteeProofPacketsMeter = metrics.NewRegisteredMeter("les/misc/out/packets/committee", nil)
