...
type TokenLimiter struct {
	...
	freeRatio, avgFreeRatio            float64
...
func (tl *TokenLimiter) averageFreeRatio(now mclock.AbsTime) float64 {
	...
	return tl.avgFreeRatio - (tl.freeRatio-tl.avgFreeRatio)*math.Expm1(-float64(dt)/float64(freeRatioTC))
}
