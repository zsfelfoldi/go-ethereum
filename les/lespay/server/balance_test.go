...
func (z zeroExpCtrl) posExpiration(mclock.AbsTime) utils.Fixed64 {
	return 0
}

func (z zeroExpCtrl) negExpiration(mclock.AbsTime) utils.Fixed64 {
	return 0
}
...
func TestSetBalance(t *testing.T) {
	...
	tracker := NodeBalance{exp: zeroExpCtrl{}}
