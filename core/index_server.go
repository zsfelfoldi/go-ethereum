...
type Indexer interface {
	...
	// Revert rewinds the index to the given head block. Subsequent AddBlockData
	// calls will deliver blocks starting from this point.
	Revert(header *types.Header)
