...
// body and receipts.
func AssembleBlock(engine consensus.Engine, chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, logIndex *logindex.Indexer, body *types.Body, receipts []*types.Receipt) *types.Block {
