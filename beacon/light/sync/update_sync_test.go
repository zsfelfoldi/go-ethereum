...
func TestUpdateSyncParallel(t *testing.T) {
	...
	ts.ServerEvent(EvNewFinalityUpdate, testServer1, types.FinalityUpdate{SignatureSlot: 0x2000*100 + 0x1000})
	ts.AddServer(testServer2, 3)
	ts.ServerEvent(EvNewFinalityUpdate, testServer2, types.FinalityUpdate{SignatureSlot: 0x2000*100 + 0x1000})
...
func TestUpdateSyncDifferentHeads(t *testing.T) {
	...
	ts.AddServer(testServer1, 1)
	ts.ServerEvent(EvNewFinalityUpdate, testServer1, types.FinalityUpdate{SignatureSlot: 0x2000*15 + 0x1000})
	ts.AddServer(testServer2, 1)
	ts.ServerEvent(EvNewFinalityUpdate, testServer2, types.FinalityUpdate{SignatureSlot: 0x2000*16 + 0x1000})
	ts.AddServer(testServer3, 1)
	ts.ServerEvent(EvNewFinalityUpdate, testServer3, types.FinalityUpdate{SignatureSlot: 0x2000*17 + 0x1000})
	...
	ts.ServerEvent(EvNewFinalityUpdate, testServer4, types.FinalityUpdate{SignatureSlot: 0x2000*17 + 0x1000})
