...
type Engine interface {
	...
	FinalizeAndAssemble(chain ChainHeaderReader, header *types.Header, state *state.StateDB, logIndex *filtermaps.LogIndexHasher, body *types.Body, receipts []*types.Receipt) (*types.Block, error)
