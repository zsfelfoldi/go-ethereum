...
// GetCtx returns the context assigned to the request
func (req *TrieRequest) GetCtx() context.Context { return req.ctx }
...
// GetCtx returns the context assigned to the request
func (req *NodeDataRequest) GetCtx() context.Context { return req.ctx }
