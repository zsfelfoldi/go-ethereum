...
type LesOdrRequest interface {
	Info(*peer) (reqType, reqAmount uint32, maxCost uint64)
	CanSend(*peer) bool
...
func (r *BlockRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetBlockBodiesMsg, 1, peer.GetRequestCost(GetBlockBodiesMsg, 1)
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetReceiptsMsg, 1, peer.GetRequestCost(GetReceiptsMsg, 1)
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *TrieRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetProofsV2Msg, 1, peer.GetRequestCost(GetProofsV2Msg, 1)
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *CodeRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetCodeMsg, 1, peer.GetRequestCost(GetCodeMsg, 1)
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *ChtRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetHelperTrieProofsMsg, 1, peer.GetRequestCost(GetHelperTrieProofsMsg, 1)
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *BloomRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetHelperTrieProofsMsg, uint32(len(r.SectionIndexList)), peer.GetRequestCost(GetHelperTrieProofsMsg, len(r.SectionIndexList))
}
...
// GetCost returns the cost of the given ODR request according to the serving
// peer's cost table (implementation of LesOdrRequest)
func (r *TxStatusRequest) Info(peer *peer) (reqType, reqAmount uint32, maxCost uint64) {
	return GetTxStatusMsg, uint32(len(r.Hashes)), peer.GetRequestCost(GetTxStatusMsg, len(r.Hashes))
}
