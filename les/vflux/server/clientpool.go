...
// clientPoolPeer represents a client peer in the cp.
...
type clientPeer interface {
	...
	UpdateCapacity(uint64, bool)
	Disconnect()
}

type clientPeerInstance struct{ clientPeer }

// NewClientPool creates a new client pool
func NewClientPool(balanceDb ethdb.Database, minCap uint64, connectedBias time.Duration, clock mclock.Clock) *ClientPool {
