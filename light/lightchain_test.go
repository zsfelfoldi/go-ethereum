...
func makeHeaderChain(parent *types.Header, n int, db ethdb.Database, seed int) []*types.Header {
	blocks, _ := core.GenerateChain(types.NewBlockWithHeader(parent), db, n, func(i int, b *core.BlockGen) {
...
func chm(genesis *types.Block, db ethdb.Database) *LightChain {
	...
	bc.hc, _ = core.NewHeaderChain(db, bc.Validator, &bc.procInterrupt, &bc.wg, &bc.mu)
